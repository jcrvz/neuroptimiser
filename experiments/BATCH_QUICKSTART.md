...
```
batch_results/
├── result_f01_i01_d02.json       # Individual results
├── result_f01_i01_d10.json
├── ...
├── summary_YYYYMMDD_HHMMSS.csv   # Generated by batch runner
├── statistics_YYYYMMDD_HHMMSS.json
└── analysis_plots/               # Generated by analyze_results.py
    ├── error_distribution_by_dimension.pdf  # Violin plots
    ├── error_distribution_by_dimension.png
    ├── error_by_function.pdf                # Grouped bar charts
    ├── error_by_function.png
    ├── operator_usage_by_dimension.pdf      # Stacked bar charts
    ├── operator_usage_by_dimension.png
    ├── error_vs_operator_usage.pdf          # Scatter with regression
    ├── error_vs_operator_usage.png
    ├── error_violin_by_function.pdf         # Violin plots
    ├── error_violin_by_function.png
    ├── performance_heatmap.pdf              # Performance heatmap
    └── performance_heatmap.png
```

## 🔍 Data Saved per Experiment
